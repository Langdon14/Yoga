...
```
There was no significant difference between test Scores of participants and conditions (A vs B) F (1, 38) = .627, p = .434. Neither did we find significance between test Scores and stress levels (low vs. high) F (1, 38) = .083, p = .774, nor test Scores within conditions (A vs. B) based on stress levels (low vs. high) F(1, 38) = .254, p = .617.
...
According to the figure, there is no significant difference between mean scores withing conditions for each stress level. This is consistent with the results of our ANOVA analysis. 

In summary, we found not short-term effect of yoga on test performance in the context of a timed math test administered via YouTube. The conditions and stress levels showed no significant differences in test scores. 